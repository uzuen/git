...
def user_profile(driver):
    user_profile = driver.find_element(By.XPATH, "//a[contains(@href, 'https://site.openmynetwork.com/dev3141567/members/student_one/profile')]")
    ...
    if "https://site.openmynetwork.com/dev3141567/members/student_one/" in driver.current_url:  
